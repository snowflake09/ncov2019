		...
		<form id="buildingAddForm" method="post">
			<table class="grid">
				<tr>
					...
					<td align="left"><input name="BUILDINGNAME" class="easyui-validatebox"
						type="text" placeholder="楼号名称"
