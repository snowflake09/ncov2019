...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="uroleEditForm" method="post">
		<input type="hidden" name="id" value="${roleDto.id }" />
			<table class="grid">
				<tr>
					<td align="right">角色名称：</td>
					<td align="left"><input name="name" class="easyui-validatebox" value="${roleDto.name }"
				...
				<tr>
					...
					<td align="left"><textarea name="discription" class="easyui-validatebox"
						data-options="required:true" maxlength="200" style="width:298px;height:68px;">${roleDto.discription}</textarea></td>
				</tr>
			</table>
		</form>
	</div>
